...
public class SendFileShareMessageListener extends PokoServer.PokoListener {
    public SendFileShareMessageListener(Context context) {
        super(context);
    }

    @Override
    public String getEventName() {
        return Constants.sendFileShareMessageName;
    }
    ...
    public void callSuccess(Status status, Object... args) {
        ...
        try {
            ...
            Log.e("POKO", "Failed to parse file message response");
        }
    }

    @Override
    public void callError(Status status, Object... args) {
        Log.e("POKO ERROR", "Failed to send file message");
    }
