...
public class PendingContactOptionDialog extends DialogFragment {
    private String[] optionStrings;
    private PendingContact contact;
    private PendingContactOptionDialogListener listener;
        ...
        builder.setTitle("옵션")
                .setItems(optionStrings, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        listener.pendingContactOptionClick(which, contact);
                    }
                });
    ...
    public void onAttach(Context context) {
        ...
        try {
            listener = (PendingContactOptionDialogListener) context;
    ...
    public interface PendingContactOptionDialogListener {
        void pendingContactOptionClick(int option, PendingContact contact);
    }
}
